...
INSERT INTO `Episode` (`id`, `showId`, `title`, `episodeNumber`, `description`, `duration`, `videoUrl`, `transcodeStatus`, `stageDetails`, `views`, `createdAt`, `updatedAt`) VALUES (328, 14, 'S1.E2 ∙ The Variant', 2, NULL, NULL, 'https://serverbuket-12.s3.ap-south-1.amazonaws.com/videos/show_14/ep_328/master.m3u8', 'COMPLETED', '{"uploadServer":{"percent":100,"speed":"Done","eta":0,"status":"COMPLETED"},"transcoding":{"percent":100,"speed":"Done","eta":0,"status":"COMPLETED"},"uploadS3":{"percent":100,"speed":"Done","eta":0,"status":"COMPLETED"}}', 2, NOW(), NOW()) ON DUPLICATE KEY UPDATE `title`='S1.E2 ∙ The Variant';
